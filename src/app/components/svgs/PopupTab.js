export default function PopupTab() {
    return (
        <svg className="popup-tab" viewBox="0 0 393 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="popup-tab">
            ...
            <defs>
                <filter id="filter0D86229" x="0" y="0" width="401" height="52" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1DropShadow86229"/>
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1DropShadow86229" result="shape"/>
                </filter>
            </defs>
        </svg>
    );
